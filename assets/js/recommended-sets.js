window.RECOMMENDED_SETS = [
  'FDN','BLB','DSK','DFT','TDM','FIN','EOE','OM1',
  'WOE','LCI','MKM','OTJ','BIG','MAT','MOM','ONE','BRO','DMU','SNC','NEO','VOW','MID','AFR','STX','KHM','ZNR','IKO','THB','ELD','M20','WAR','RNA','GRN','M19','DOM','RIX','XLN','HOU','AKH','AER','KLD','EMN','SOI','OGW','BFZ',
