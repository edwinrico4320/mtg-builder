...
`;
  ...
  function catalogPreview() {
    ...
    return `<div id="top"></div><div class="page"><header class="set-header"><h1>Sample Set</h1><div class="set-sub">Set Code: SMP · Live design preview</div></header><div class="layout">${nav}<main class="cards"><article id="card-1" class="card-entry"><div class="card-header"><h2>Aether Channeler</h2><strong>{2}{U}</strong></div><div class="card-body"><div class="image-wrap"><div class="image-placeholder">Embedded card image preview</div></div><div class="card-copy"><div class="type-line">Creature — Human Wizard</div><div class="rules-box"><strong>Oracle Text</strong><p>When this creature enters, choose one — create a token; return another nonland permanent; or draw a card.</p></div><div class="flavor-box">“Every current has a story.”</div><div class="stats-box"><span class="stats-badge">2/1</span></div><p class="back-top"><a href="#top">Back to top</a></p></div></div></article><article id="card-2" class="card-entry"><div class="card-header"><h2>Sample Dragon</h2><strong>{4}{R}{R}</strong></div><div class="card-body"><div class="image-wrap"><div class="image-placeholder">Second image</div></div><div class="card-copy"><div class="type-line">Creature — Dragon</div><div class="rules-box">Flying<br>Whenever this attacks, it deals 2 damage to any target.</div><div class="stats-box"><span class="stats-badge">5/5</span></div></div></div></article></main></div></div>`;
  }
