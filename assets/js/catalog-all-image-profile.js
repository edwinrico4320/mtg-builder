(function () {
  ...
  function init(){ const btn=$('buildAllCatalogsBtn'); if(btn) btn.addEventListener('click', buildAll, true); if(typeof BuilderModules!=='undefined') BuilderModules.register('All-Sets Image Profile','8.7.0'); }
