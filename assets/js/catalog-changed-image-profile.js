(function () {
  ...
  function init(){ const btn=$('buildChangedCatalogsBtn'); if(btn) btn.addEventListener('click', buildChanged, true); if(typeof BuilderModules!=='undefined') BuilderModules.register('Changed/New Image Profile','8.3.0'); }
